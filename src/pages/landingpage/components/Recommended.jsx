...
const recommendedProducts = [
  {
    ...
    description: 'Classic lightweight everyday backpack with spacious main compartment.'
  },
  {
    id: 2,
    brand: 'Supergoop!',
    ...
    description: '100% invisible, weightless, scentless sunscreen with SPF 40 protection.'
  },
  {
    id: 3,
    brand: 'UGG',
    ...
    description: 'Iconic sheepskin boots designed to keep your feet cozy and comfortable.'
  },
  {
    id: 4,
    brand: 'Ray-Ban',
    ...
    description: 'Timeless style and superior UV protection with durable acetate frames.'
  },
];

export default function Recommended({ onSelectProduct }) {
  return (
