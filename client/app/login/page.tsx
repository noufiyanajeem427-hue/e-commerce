...
function LoginForm() {
  ...
  const handleDemoClick = (type: "vip" | "admin") => {
    demoLogin(type);
    router.push(redirectUrl);
  };
        ...
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 bg-zinc-900/70 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-2xl">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-center">
            <div className="max-w-md w-full mx-auto space-y-6">
              ...
              <div className="p-3.5 rounded-2xl bg-gradient-to-r from-indigo-950/40 via-purple-950/30 to-amber-950/20 border border-indigo-500/20 space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="font-bold text-zinc-300 flex items-center gap-1.5">
                    <KeyRound className="w-3.5 h-3.5 text-amber-400" /> Instant Demo Sign-In:
                  </span>
                  <span className="text-[10px] text-zinc-500">1-Click Test Mode</span>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <button
                    type="button"
                    onClick={() => handleDemoClick("vip")}
                    className="flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 text-amber-300 border border-amber-500/30 text-xs font-semibold transition group shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 text-indigo-300 border border-indigo-500/30 text-xs font-semibold transition group shadow-sm"
                  >
                    <ShieldCheck className="w-3.5 h-3.5 text-indigo-400 group-hover:scale-110 transition" />
              ...
              <div className="space-y-3">
                <div className="relative flex items-center justify-center">
                  ...
                  <span className="bg-zinc-900 px-3 text-[10px] text-zinc-500 uppercase tracking-widest font-bold">
                    Or continue with
                  </span>
                  <div className="border-t border-zinc-800/80 w-full" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <button
                    type="button"
                    onClick={() => handleDemoClick("vip")}
                    className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-zinc-950 hover:bg-zinc-800/80 border border-zinc-800 text-xs text-zinc-200 font-medium transition"
                  >
                  ...
                  >
                    <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
                      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.62-.75 1.04-1.8 0.92-2.85-.9.04-1.99.6-2.64 1.35-.57.65-1.06 1.7-0.93 2.71 1.01.08 2.03-.46 2.65-1.21z" />
                    </svg>
                    <span>Apple ID</span>
                  </button>
                </div>
